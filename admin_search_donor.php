...
$sql = mysql_query("select * from donor where donor_id  COLLATE latin1_general_cs like '$term'");
...
while ($row = mysql_fetch_array($sql)){
   ...
   // echo '<br/> ID: '.$row['id'];
	...
	echo "<BR>";
echo "<a href='admin_search_res_donor.php' title='Search again'>Search Another Blood Info</a>";
echo "<BR>";
